...
class SplitDetectionModel(nn.Module):
    def __init__(self, cfg='yolov8n.yaml', ch=3, nc=None, verbose=False, scale='n',
        ...
        if isinstance(cfg, str):
            ...
            self.model, self.save = parse_model(deepcopy(self.yaml), ch=ch, verbose=verbose, scale=scale)  # model, savelist
...
def parse_model(d, ch, verbose=False, scale='n'):  # model_dict, input_channels(3)
